...
{   $id = $_GET["id"];
    ...
    $edit = $controller->getEditMember($id,$name, $surname,$birthDay,$birthPlace,$birthCountry, $deathDay, ($deathPlace == ''?null:$deathPlace), ($deathCountry == ''?null:$deathCountry) );
}
?>
...
<section id="success-section">
   <article id="success-article">
       <div id="success">
           <?php
           if ($edit > 0)
               echo "<span>Úprava prebehla úspešne</span>";
           else if($edit == 0 || $edit == null)
               echo "<span>Úprava prebehla neúspešne</span>";
           else
